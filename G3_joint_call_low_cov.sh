...
in_database=/scratch/tmp/ayroles/alea_files/low_cov_all/$chrom
in_samples=/Genomics/ayroleslab2/alea2/all_low_cov.sample_map
out_vcf_gz=/scratch/tmp/ayroles/alea_files/low_cov_all/$chrom.all_low_cov.vcf.gz

# merge GVCFs
$in_gatk/gatk --java-options "-Xmx80g -Xms80g" GenomicsDBImport \
            --sample-name-map $in_samples \
            --genomicsdb-workspace-path /scratch/tmp/ayroles/alea_files/low_cov_all/$chrom \
